...
if not sys.executable:
    ...
    data1 = ["I'm Sarah, and I work for a digital rights management/viral clip agency known as Claimable.", "My name is Sarah and I work for a digital rights management and viral clip agency known as Claimable. Essentially we search the internet for clips we think have the ability to go viral and purchase them for the purposes of compilations on YouTube.", "I work for a company called Claimable that specializes in digital rights management and viral clips."]
